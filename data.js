...
const websiteData = {
  ...
  sidebarData: {
    ...
    info: [
      ...
      { label: "Work Status", value: "Available", highlight: true },
    ],
    languages: [
  ...
  getSkillsData: (nextColor) => [
    ...
    { id: 14, name: "Tanstack", icon: TanstackIcon, color: nextColor },
    ...
    // { id: 11, name: "Python", icon: PythonIcon, color: "#F7DF1E" },
    { id: 12, name: "Chakra UI", icon: ChakraIcon, color: "#0DC8AB" },
